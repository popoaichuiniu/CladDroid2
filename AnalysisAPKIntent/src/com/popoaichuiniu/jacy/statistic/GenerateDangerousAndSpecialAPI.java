...
public class GenerateDangerousAndSpecialAPI {
    ...
    public static void main(String[] args) {
        ...
        WriteFile writeFile = new WriteFile("dangerous_api.txt", false, looger);

        System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");

        Map<String, List<String>> apiPermission = androidInfo.getPermissionDangerousAndSpecialMethods();
        ...
        for (Map.Entry<String, List<String>> entry : apiPermission.entrySet()) {
            ...
            writeFile.writeStr(convertedApI + " " + "-> _SINK_" + "\n");
