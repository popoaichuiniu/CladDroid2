...
public class IntentConditionTransformPathInsensitive extends SceneTransformer {
    ...
    private static Logger exceptionLogger = new MyLogger("AnalysisAPKIntent/intentConTranPathInsensitive", "exceptionLogger").getLogger();
    ...
    protected void internalTransform(String phaseName, Map<String, String> options) {
        ...
        for (SootMethod sootMethod : roMethods) {
            ...
            IntentFlowAnalysis intentFlowAnalysis = new IntentFlowAnalysis(briefUnitGraph, exceptionLogger);
