...
public class GenerateUnitNeedToAnalysis {//日志设置合理
    ...
    public static void main(String[] args) {
        ...
        if (appDir.isDirectory()) {
            ...
            File hasGeneratedAPPFile = new File(Config.unitNeedAnalysisGenerate + "/" + appDir.getName() + "_hasGeneratedAPP_GenerateUnitNeedToAnalysis.txt");
            ...
            Set<String> hasGenerateAppSet = new ReadFileOrInputStream(Config.unitNeedAnalysisGenerate + "/" + appDir.getName() + "_hasGeneratedAPP_GenerateUnitNeedToAnalysis.txt", exceptionLogger).getAllContentLinSet();
            WriteFile writeFileHasGenerateUnitNeedAnalysis = new WriteFile(Config.unitNeedAnalysisGenerate + "/" + appDir.getName() + "_hasGeneratedAPP_GenerateUnitNeedToAnalysis.txt", true, exceptionLogger);//分析一个目录中途断掉，可以继续重新分析
