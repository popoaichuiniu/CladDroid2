...
public class ProcessManifest {
	 ...
	 */
	protected String expandClassName(String className) {
	...
	public Set<String> getEntryPointClasses() {
		...
		String appName = getApplicationName();//不是应用的名字 ，是application标签
	 ...
	 * otherwise false
	 */
	protected boolean isValidComponentName(String name) {
		if (name.isEmpty())
			return false;
