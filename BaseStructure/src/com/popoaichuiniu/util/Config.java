...
public class Config {
    ...
    public  static String testAppPath="experiment_data_paper/videoDemo.apk";
    ...
    public static String instrumented_name_SE="instrumented_SE";
    public static String instrumented_name_DynamicSE="instrumented_DynamicSE";
    public static String instrumented_name_IntentFuzzer="instrumented_IntentFuzzer";
    public static String default_instrumented_name=Config.instrumented_name_SE;
    ...
    public static String intent_file_path=intentConditionSymbolicExcutationResults+"/"+"intent_file";

    public static String intent_ulti_path=intentConditionSymbolicExcutationResults+"/"+"intent_ulti";

    public static String unitNeedAnalysisGenerate = logDir+"/"+"unitNeedAnalysisGenerate";

    public static String unitNeedInstrument = logDir+"/"+"unitNeedInstrument";
