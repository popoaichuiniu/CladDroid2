...
public class AbstractionAtSink {
	 ...
	 * @param abstraction The abstraction with which the sink has been reached  //The abstraction class contains all information that is necessary to track the taint.
